...
namespace vor
{
  ...
  public:
    ...
    void getNbrs(UInt posIndx, const std::vector<Array<real_t, 3> > & pos, std::vector<UInt> & indcs) const;
    inline bool empty(const UInt indxCell) const;
    inline void getCellContent(const UInt indxCell, typename std::vector<PosAndId<UInt, real_t> >::const_iterator & begin, typename std::vector<PosAndId<UInt, real_t> >::const_iterator & end) const;
...
#pragma omp parallel for
  ...
  template< typename UInt, typename real_t>
  void NbrList<UInt, real_t>::getGridNbrs(const Array<real_t, 3> & pos, std::vector<UInt> & nbrs) const
  {
    Array<Indx, 2> indcs;
    const Array<real_t, 3> & L(p_box->getL());
    for(uint0 k(0); k<3; ++k){
...
//     }
  ...
  template< typename UInt, typename real_t>
  void NbrList<UInt, real_t>::getCellContent(const UInt indxCell, typename std::vector<PosAndId<UInt, real_t> >::const_iterator & begin, typename std::vector<PosAndId<UInt, real_t> >::const_iterator & end) const
  {
  ...
  template< typename UInt, typename real_t>
  void NbrList<UInt, real_t>::getNbrs(const UInt indxPos, const std::vector<Array<real_t, 3> > & pos, std::vector<UInt> & indcs) const
  {
